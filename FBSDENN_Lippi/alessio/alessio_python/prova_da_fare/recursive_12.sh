...
cd /export/home/alessio.rondelli2/alessio_python
python recursive1.py \
  --mode recursive \
  ...
  --N 40 \
  --passes 3 \
  --training_plan_csv training_recursive.csv \
  --pass1_init base \
  --output_dir results/t12_b10_base_xpass_ws \
  --eval_bundle_path results/eval_bundle_T12_B10_M2000_N40.npz
...
python recursive1.py \
  ...
  --output_dir results/t12_b10_coarse_xpass_ws \
  --eval_bundle_path results/eval_bundle_T12_B10_M2000_N40.npz
...
python recursive1.py \
  ...
  --output_dir results/t12_b10_base_no_xpass_ws \
  --eval_bundle_path results/eval_bundle_T12_B10_M2000_N40.npz
