...
def main():
    ...
    parser.add_argument("--date", type=str, default="2025settembre4")
    parser.add_argument(
        "--passes",
        type=int,
        default=2,
    ...
    layers = [D + 1] + 4 * [256] + [1]
    stage_plan = [(6000, 1e-3), (4000, 5e-4), (4000, 1e-4), (4000, 5e-5)]
    final_plan = [(2500, 1e-5), (2500, 5e-6)]
